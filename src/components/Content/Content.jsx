        ...
        <div className={styles.imp2}>
          ...
          <div className={styles.historyEkaterinaI}>
            ...
            <div className={styles.Text}>
              ...
              <span> именным</span> указом Екатерины I Инженерная часть выделена из ведения
        ...
        <div className={styles.imp3}>
          ...
          <div className={styles.historyElizabeth}>
            ...
            <div className={styles.textShuv}>
              ...
              было возложено на инженер-капитана<br/> М. И. Мордвинова.{" "}
        ...
        <div className={styles.imp6}>
          ...
          <div className={styles.historyAlexanderI}>
            ...
            <div className={styles.descKorpus}>
              ...
              воспитанники Второго Кадетского корпуса разделены на 4 роты: одну гренадерскую и
              три мушкетерские. <br />
            ...
            <div className={styles.descKorpus2}>
              ...
              дворян, обучавшихся в Первом и Втором кадетских корпусах, сформированы 1-й и 2-й Дворянские батальоны. <br />
            ...
            <div className={styles.descShtat}>
              ...
              руководство им осуществлял А.И. Маркевич, сын
              подполковника С.А. Маркевича, инспектор классов Второго
              кадетского корпуса. Им был написан первый исторический рукописный
        ...
        <div className={styles.imp7}>
          ...
          <div className={styles.historyNikolayI}>
            ...
            <div className={styles.descSenat}>
              ...
              генерал-майоры Ф. Г. Кальм, И.К. Арнольди,<br/> Н. М. Попов; полковники
              И.Г. Бурцов и М.Ф. Митьков; подполковники Г.С. Батеньков и А.К.
              Берстель; майоры <br/>В.Ф. Раевский и Н.И.Лорер; капитаны Н.Н. Семичев
            ...
            <div className={styles.descFlag1}>
              ...
              портрет фельдмаршала, Светлейшего князя, Голенищева-Кутузова-Смоленского, как бывшего воспитанника учебного заведения.
            </div>
        ...
        <div className={styles.imp9}>
          <div className={styles.historyAlexanderIII}>
            ...
            <div className={styles.descNev}>
              ...
              академика <br/>Ф.И. Демерцова в 1803 году, освящен 24 мая 1804 года.
              <br />
