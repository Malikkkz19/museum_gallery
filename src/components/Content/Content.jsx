        ...
        <div className={styles.imp2}>
          ...
          <div className={styles.historyEkaterinaI}>
            ...
            <div className={styles.Text}>
              ...
              <span> именным</span> указом Екатерины I Инженерная часть выделена
              из ведения Канцелярии Главной Артиллерии и подчинена особой
              Инженерной конторе под руководством графа фон Миниха. <br />
              <b style={{ paddingLeft: "10px" }}>В 1733 году</b> Инженерная
              школа переведена в построенный для неё казенный деревянный дом на
        ...
        <div className={styles.imp3}>
          ...
          <div className={styles.historyElizabeth}>
            ...
            <div className={styles.textSuvorov}>
              ...
              в возрасте 17 лет, был произведен в капитаны и направлен в Старую
            ...
            <div className={styles.textShuv}>
              ...
              было возложено на инженер-капитана
              <br /> М. И. Мордвинова.{" "}
              <span style={{ paddingLeft: "10px" }}>На момент </span>
              объединения Инженерная школа (как и Артиллерийская) находилась в
              ведении Канцелярии Главной Артиллерии и Фортификации и подчинялась
              инженер-генерал-майору Абраму Петровичу Ганнибалу.{" "}
              ...
              детей), с которой в 1759 году была соединена школа для детей
            ...
            <div className={styles.textSchool}>
              ...
              Артиллерийского и инженерного шляхетного кадетского корпуса была
        ...
        <div className={styles.imp4}>
          ...
          <div className={styles.historyEkaterinaII}>
            ...
            <div className={styles.descArakcheev} alt="Desc Arakcheev">
              ...
              <br />
              <span style={{ paddingLeft: "10px" }}>С</span> 1 января 1810 года
            ...
            <div className={styles.descCadets}>
              ...
              организована Греческая гимназия, которая в 1792 году преобразована
              в Корпус чужестранных единоверцев. <br />
        ...
        <div className={styles.imp6}>
          ...
          <div className={styles.historyAlexanderI}>
            ...
            <div className={styles.descKorpus}>
              ...
              воспитанники Второго Кадетского корпуса разделены на 4 роты: одну
              гренадерскую и три мушкетерские. <br />
            ...
            <div className={styles.descKorpus2}>
              ...
              дворян, обучавшихся в Первом и Втором кадетских корпусах,
              сформированы 1-й и 2-й Дворянские батальоны. <br />
              ...
              для дворян, готовившихся к кавалерийской службе, учреждён
            ...
            <div className={styles.descShtat}>
              ...
              1823 год занимал генерал от инфантерии Пётр Петрович Коновницын.{" "}
              <br />
              ...
              Корпусе А.А. Клейнмихеля и Д.Д. Куруты (с 1804 по 1832 год )
              руководство им осуществлял А.И. Маркевич, сын подполковника С.А.
              Маркевича, инспектор классов Второго кадетского корпуса. Им был
              написан первый исторический рукописный труд «Краткая история
              Второго кадетского корпуса».
            </div>
          </div>
        </div>
        <div className={styles.imp7}>
          ...
          <div className={styles.historyNikolayI}>
            ...
            <div className={styles.descSenat}>
              ...
              генерал-майоры Ф. Г. Кальм, И.К. Арнольди,
              <br /> Н. М. Попов; полковники И.Г. Бурцов и М.Ф. Митьков;
              подполковники Г.С. Батеньков и А.К. Берстель; майоры <br />
              В.Ф. Раевский и Н.И.Лорер; капитаны Н.Н. Семичев и С.О. Розен;
              поручик Д. А. Нащокин и разжалованный из штабс-капитанов в рядовые
              Д. Грахольский. <br />
            ...
            <div className={styles.descMendeleev}>
              ...
              физическую географию и химию преподавал 27-летний магистр физики и
              химии Дмитрий Иванович Менделеев, создавший в учебных классах
              Корпуса самую первую в Санкт-Петербурге химическую лабораторию.
              Кадеты 2-го кадетского корпуса тоже стали первыми, кто
              познакомился с его знаменитой Периодической таблицей химических
              элементов.
            </div>
            ...
            <div className={styles.descReforma1}>
              ...
              военная гимназия была переименована во Второй кадетский корпус.
            ...
            <div className={styles.descFlag1}>
              ...
              Императором Николаем I Второму Кадетскому Корпусу пожалованы:
              ...
              портрет фельдмаршала Светлейшего князя
              Голенищева-Кутузова-Смоленского как бывшего воспитанника учебного
              заведения.
            </div>
            <div className={styles.descFlag2}>
              <span style={{ paddingLeft: "10px" }}>25</span> июля 1838 года
              Указом Императора Николая I Второму кадетскому корпусу были
              пожалованы на знамена: юбилейные знаки отличия, орденская
              Андреевская лента и скоба на древко как старейшему военно-учебному
              заведению. Торжественный ритуал прибивки знамени состоялся 11
              сентября 1838 года в 19 часов в столовой зале Кадетского корпуса,
              в присутствии представителей императорской фамилии и генералитета
              Русской армии.
            </div>
          </div>
        </div>
          ...
          <div className={styles.historyAlexanderII}>
            ...
            <div className={styles.descMonah}>
              <div style={{ textAlign: "center" }}>
                СВЯЩЕННОИСПОВЕДНИК МИХАИЛ СОЮЗОВ, ПРЕСВИТЕР 1869-1922 гг.
              </div>{" "}
              <img
              ...
              <div style={{ fontSize: "6px" }}>
                ...
                канонизирован как священноисповедник решением Священного синода
                Русской православной церкви в 2022 году. <br />
        ...
        <div className={styles.imp9}>
          <div className={styles.historyAlexanderIII}>
            ...
            <div className={styles.descNev}>
              ...
              академика <br />
              Ф.И. Демерцова в 1803 году, освящен 24 мая 1804 года.
              <br />
              ...
              Святого Благоверного Князя Александра Невского («верхняя»,
              «холодная») <br />
        ...
        <div className={styles.imp10}>
          <div className={styles.historyNikolayII}>
            ...
            <div className={styles.descNik2}>
              ...
              отдано старшинство со дня образования Инженерной школы. <br />
              <span style={{ paddingLeft: "10px" }}>16</span> января 1912 года
            ...
            <div className={styles.mainSchool}>
              ...
              >
                ...
                <div className={styles.mainSchoolText}>
                  ...
                  школы был собран цвет армейского спорта. <br />
                  ...
                  Всероссийской олимпиаде в Киеве в 1913 году школа завоевала
                  1-е общекомандное место. <br />
                  ...
                  самой школы, занималась разработкой и внедрением методических
                  рекомендаций по проведению занятий гимнастикой и фехтованием в
                  войсках.
                </div>
